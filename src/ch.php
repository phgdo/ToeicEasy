<?php
    ...
    // Set 2 giá trị i cho vòng for ban đầu (Mặc định sẽ ở phần nhập part 1)
    $ibegin = 1;
    $iend = 6;
    if(isset($_POST['btnSelectRange1'])){
        $ibegin = 1;
        $iend = 6;
    }
...
<main style="min-height: 100vh; max-width: 100%;">
        ...
        <h3>Thêm và sửa:</h3>
        <input type="submit" name="btnSelectRange1" value="Part 1" class="btn btn-primary">
        <input type="submit" name="btnSelectRange2" value="Part 2" class="btn btn-primary">
        <input type="submit" name="btnSelectRange3" value="Part 3" class="btn btn-primary">
        <input type="submit" name="btnSelectRange4" value="Part 4" class="btn btn-primary">
        <input type="submit" name="btnSelectRange5" value="Part 5" class="btn btn-primary">
        <input type="submit" name="btnSelectRange6" value="Part 6" class="btn btn-primary">
        <input type="submit" name="btnSelectRange7" value="Part 7" class="btn btn-primary">
